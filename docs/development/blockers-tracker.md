...
| CI-001   | Frontend visual baselines  | Remediating | CI run `35616905361` on `c737a8d` failed only in three visual assertions: Earn review (expected 1068px, received 956px), Sync Queue mobile empty (expected 1936px, received 1988px), and Capture Purchase route (expected 1398px, received 1286px). Actual CI artifacts were inspected; only those three snapshots are being reconciled. |
