...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------ |
| Next/Vercel frontend | Candidate preview `shopcity-jgljno32l-micah-s-projects-bb6507fe.vercel.app`; deployment `dpl_7roRBWYFtcJpWKSkUDPK2PTTsU8p`; SHA `c388a96`; build `sfo1`, runtime `iad1` | Exact candidate preview verified | Confirm production promotion only after approval                               |
