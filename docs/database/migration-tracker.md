...
| 2026-07-19 | Phase 1 auth/bootstrap hardening | No new migration | Live HTTP auth/readiness smoke test added with Testcontainers-backed Postgres + Redis | Bootstrap docs now include migrate deploy and seed; session lifecycle and readiness behavior are verified over HTTP. |
