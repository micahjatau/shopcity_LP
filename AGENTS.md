...
This project is indexed by GitNexus as **shopcity_LP** (1997 symbols, 3194 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
