...
This project is indexed by GitNexus as **shopcity_LP** (2657 symbols, 4445 relationships, 88 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
