...
This project is indexed by GitNexus as **shopcity_LP** (1455 symbols, 2316 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
