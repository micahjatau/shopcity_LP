...
- [ ] 6.2 Keep role selection informational only and preserve backend session issuance, role routing, recovery, logout, and expiry behavior; verify role-boundary and session tests.
...
- [ ] 7.3 Add and review the approved visual-deviation registry, including registration contract differences and omitted Till/cashier reference; verify every deviation has a reason and replacement.
