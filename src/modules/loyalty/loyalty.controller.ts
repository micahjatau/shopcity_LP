...
const transactionResponseSchema = {
  ...
  properties: {
    ...
    cardSerialNumber: { type: 'string', nullable: true },
    posReceiptNumber: { type: 'string', nullable: true },
    purchaseAmountKobo: { type: 'integer', nullable: true },
    occurredAt: { type: 'string', format: 'date-time' },
    capturedAt: { type: 'string', format: 'date-time' },
    state: { type: 'string', example: 'CONFIRMED' },
    captureStatus: { type: 'string', nullable: true, example: 'CAPTURED' },
    reviewStatus: { type: 'string', nullable: true, example: 'APPROVED' },
    ...
    adjustment: {
      type: 'object',
      nullable: true,
      required: ['id', 'kind', 'reason', 'createdBy'],
      properties: {
        id: { type: 'string', format: 'uuid' },
    ...
    reversal: {
      ...
      properties: {
        originalTransactionId: { type: 'string', format: 'uuid', nullable: true },
        restorations: {
          type: 'array',
          items: {
            type: 'object',
