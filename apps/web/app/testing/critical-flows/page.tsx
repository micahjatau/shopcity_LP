        ...
        <div style={gridTwo}>
          ...
          <article style={cardStyle} data-testid="flow-session-revocation">
            ...
            <div style={actionsStyle}>
              ...
              <Button variant="danger">Request re-authentication</Button>
            </div>
          </article>
        </div>
      </WorkflowSection>
      ...
      >
        <div style={gridTwo}>
          ...
          <article style={cardStyle} data-testid="flow-duplicate-receipt">
            ...
            />
            <div style={actionsStyle}>
              <Button variant="danger">Flag duplicate</Button>
              <Button variant="secondary">Keep pending</Button>
            </div>
          </article>
        </div>
      </WorkflowSection>
      ...
      >
        <div style={gridTwo}>
          <article style={cardStyle} data-testid="flow-redeem-confirmed">
            ...
            <div style={actionsStyle}>
              <Button>Print redemption slip</Button>
      ...
      >
        <div style={gridTwo}>
          ...
          >
            ...
            />
            <div style={actionsStyle}>
              <Button variant="danger">Revoke device</Button>
              <Button variant="secondary">Rotate session</Button>
            </div>
          </article>
        </div>
      </WorkflowSection>
